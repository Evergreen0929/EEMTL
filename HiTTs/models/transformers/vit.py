...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        reshaped_fea = []
        C = selected_fea[0].shape[-1]
        for fea in selected_fea:
            reshaped_fea.append(fea.view(B, H // 16, W // 16, C).permute(0, 3, 1, 2))
...
def vit_base_patch16_384(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, select_list=[3,6,9], **kwargs)
