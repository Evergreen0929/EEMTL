...
parser.add_argument('--trained_model', default=None,
                    help='Config file for the experiment')
parser.add_argument('--dataset_log', default='NYUD',
                    help='Dataset config for the experiment')
...
def main():
    ...
    if args.local_rank == 0:
        ...
        if args.run_mode != 'infer':
            ...
            wandb.init(project="TPAMI_{}".format(args.dataset_log), name=p.version_name, sync_tensorboard=True,
                       dir=os.path.abspath(tb_log_dir))
    ...
    # if args.local_rank == 0:
    #     print("Model Parameters: {}M, FLOPs: {}G".format(params / 1e6, flops / 1e9))
